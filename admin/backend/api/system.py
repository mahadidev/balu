"""
System management API routes for the admin panel.
Handles system-wide operations like clearing data and settings.
"""
...
async def clear_all_data(
    ...
    try:
        ...
        try:
            ...
            cleared_items['cache_entries'] = 1  # We don't know exact count, so use 1 to indicate cleared
        except Exception as e:
            # Log but don't fail the whole operation
            print(f"Warning: Failed to clear Redis cache: {e}")
        
        # Note: WebSocket broadcast could be added here if needed
